...
#using this to encode the categorical attributes into quantitative ones so that they can be used.
le = LabelEncoder()
...
print("R2 Score: ", r2_score(Y_test,see) )
print("F1 Score: ",f1_score(Y_test,see,average='weighted'))
print("Precision: ",precision_score(Y_test,see,average='weighted'))
print("Recall: ",recall_score(Y_test,see,average='weighted'))
print("Confusion Matrix:\n")
sns.heatmap(confusion_matrix(Y_test,see),annot = True,cmap="Reds")

data = pd.merge(dataset, labels)
# Scatter plot matrix which helps us to find trends in the data
